...
import { Binary, Calendar, DollarSign, WrapText } from "lucide-react";
...
export const CreateColumnModal = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      if (response) {
        router.refresh();
        modalUse.onClose();
        toast.success("Report column created.", {
          id: toastId,
        });
        form.reset();
      }
  ...
  const listType = [
    ...
    },
    {
      ...
      active: type === "int" ? "border border-blue-500 bg-blue-100" : "",
    },
    {
      id: 3,
      label: "Number ( money )",
      ...
      active: type === "float" ? "border border-blue-500 bg-blue-100" : "",
    },
    {
      id: 4,
      label: "Date",
